---
title: "Plotting Categorical Variables using R"
author: "Ashique.org"
...
```{r}
pie(freq_tab,labels = c("Female","Male"),col = c("green","yellow"),main="Gender distribution in the Data")
```
...
```{r}
boxplot(LungCapData$LungCap~Smoke,las=1,main="Lungs Capacity with Smoking Habit",notch=T)
```
